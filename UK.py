...
def main(TradingSymbol):
    ...
    int15_df = msft.history(period="5d",interval='15m')
...
fnostocks = [
    "AZN.L", "AZNL.XC", "SHEL.L", "SHELL.XC", "BHP.L", "BHPL.XC", "HSBA.L", "HSBAL.XC",
    "BP-A.L", "BP-B.L", "ULVRL.XC", "ULVR.L", "BC94.L", "RIO.L", "RIOL.XC", "BPL.XC", "BP.L",
    "GSKL.XC", "GSK.L", "DGEL.XC", "DGE.L", "RELL.XC", "REL.L", "GLEN.L", "GLENL.XC", "BATSL.XC",
    "BATS.L", "BNC.L", "LSEG.L", "GACA.L", "SANB.L", "RKT.L", "RKTL.XC", "NG.L", "NGL.XC",
    "GACB.L", "CRH.L", "CRHL.XC", "CPGL.XC", "CPG.L", "0M69.IL", "BAL.XC", "BA.L", "LLOY.L",
    "WDS.L", "WDSL.XC", "HLN.L", "HLNL.XC", "NOVOBC.XC", "FERG.L", "FERGL.XC", "0QIU.IL", "LLOYL.XC",
    "EXPNL.XC", "EXPN.L", "0Z4S.IL", "0R2V.IL", "0QYP.IL", "AALL.XC", "AAL.L", "APCD.XC", "MSFD.XC",
    "RR.L", "RRL.XC", "FLTRL.XC", "FLTR.L", "0R22.IL", "AHT.L", "AHTL.XC", "0RUK.IL", "PRU.L",
    "PRUL.XC", "III.L", "BARCL.XC", "BARC.L", "TSCO.L", "TSCOL.XC", "STAN.L", "NWG.L", "SSE.L",
    "SSEL.XC", "0RYA.IL", "NWGL.XC", "VOD.L", "VODL.XC", "0HD6.IL", "0RIH.IL", "WPM.L", "ABFL.XC",
    "ABF.L", "STANL.XC", "ANTO.L", "ANTOL.XC", "IMBL.XC", "IMB.L", "0QFP.IL", "ABECD.XC", "ABEAD.XC",
    "CCL.L", "CCLL.XC", "LGEN.L", "LGENL.XC", "AMZD.XC", "BTL.XC", "BT-A.L", "NVDD.XC", "IHG.L",
    "IHGL.XC", "AV.L", "AVL.XC", "SGE.L", "SGEL.XC", "KNM.L", "RTOL.XC", "RTO.L", "BNZL.L",
    "BNZLL.XC", "SMTL.XC", "NXTL.XC", "SMT.L", "NXT.L", "SGROL.XC", "SGRO.L", "INF.L", "INFL.XC",
    "0QZI.IL", "EQNRO.XC", "SNL.XC", "SN.L", "0M2Z.IL", "WISE.L", "WISEL.XC", "FB2AD.XC", "HLMA.L",
    "CCHL.XC", "HLMAL.XC", "JD.L", "CCH.L", "JDL.XC", "AIBG.L", "S32L.XC", "S32.L", "ADML.XC",
    "0R37.IL", "ADM.L", "CNAL.XC", "0XXT.IL", "CNA.L", "ATCOAS.XC", "SKGL.XC", "SKG.L", "0XXV.IL",
    "WPPL.XC", "WPP.L", "MROL.XC", "SVT.L", "MRO.L", "SVTL.XC", "SPX.L", "0NUG.L", "0R0X.IL",
    "SPXL.XC", "IAG.L", "MNDI.L", "MNDIL.XC", "BRYND.XC", "UU.L", "IAGL.XC", "UUL.XC", "SBRY.L",
    "SBRYL.XC", "RICO.L", "WTBL.XC", "WTB.L", "ITRK.L", "ITRKL.XC", "CRDAL.XC", "CRDA.L", "SDR.L",
    "SDRL.XC", "PSON.L", "PSONL.XC", "PSH.L", "PSHL.XC", "AV-A.L", "AUTO.L", "0NC6.IL", "AUTOL.XC",
    "TL0D.XC", "ENTL.XC", "ENT.L", "SMIN.L", "SMINL.XC", "AV-B.L", "0RJ4.IL", "OCDOL.XC", "OCDO.L",
    "BMEL.XC", "DCCL.XC", "DCC.L", "BME.L", "BDEVL.XC", "BDEV.L", "MNG.L", "MNGL.XC", "PHNX.L",
    "0LCV.IL", "0NZF.IL", "0HTP.IL", "0MHW.IL", "LAND.L", "LANDL.XC", "MKS.L", "MKSL.XC", "PHNXL.XC",
    "0LOS.L", "TW.L", "TWL.XC", "0Q1F.IL", "BKGL.XC", "BKG.L", "CTECL.XC", "CTEC.L", "AAF.L",
    "AAFL.XC", "3V64D.XC", "ICPL.XC", "ICP.L", "WEIR.L", "WEIRL.XC", "FCIT.L", "FCITL.XC", "0R0O.IL",
    "DPLML.XC", "DPLM.L", "0QZ0.IL", "1YDD.XC", "INVR.L", "BRBYL.XC", "BRBY.L", "RMVL.XC", "0N4T.IL",
    "RMV.L", "UTG.L", "PSNL.XC", "PSN.L", "UNHD.XC", "UTGL.XC", "CMCD.XC", "HWDN.L", "HWDNL.XC",
    "FRES.L", "FRESL.XC", "KGF.L", "KGFL.XC", "DPH.L", "DPHL.XC", "0YXG.L", "IMIL.XC", "0KZC.L",
    "IMI.L", "0R1W.IL", "HIK.L", "HIKL.XC", "SMDSL.XC", "SMDS.L", "0R1M.IL", "FRASL.XC", "FRAS.L",
    "SMSNL.XC", "SMSDL.XC", "WMTD.XC", "SXS.L", "SXSL.XC", "RS1.L", "RS1L.XC", "EDV.L", "EZJ.L",
    "EDVL.XC", "EZJL.XC", "STJ.L", "STJL.XC", "BLND.L", "BLNDL.XC", "HSX.L", "0R2Z.IL", "HSXL.XC",
    "SMSN.IL", "0GUX.L", "0HAU.IL", "SMSD.IL", "M4ID.XC", "XONAD.XC", "0NOF.IL", "0LEA.L", "HLL.XC",
    "INVP.L", "HL.L", "BEZ.L","TYT.L"
]
